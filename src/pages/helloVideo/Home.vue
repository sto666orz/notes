          ...
          question_analysis: [
            {
              analysis_type: 1,
              analysis_content:
                "在6/8拍中，是以八分音符为一拍，每小节有六拍，强弱规律的是强弱弱，次强弱弱，我们在音值组合的时候，将整个小节分为两组音群，将第1第2第3拍组合在一起，将第4第5第6拍组合在一起，按照这种组合方式，所以选择第一个选项",
            },
            {
              analysis_type: 3,
              analysis_content:
          ...
          question_stem: [
            {
              stem_type: 1,
              stem_content:
                "第一节四五六七八九十第二节四五六七八九十第三节四五六七八九十第四节四五六七八九十第五节四五六七八九十",
            },
            {
              stem_type: 2,
              stem_content:
          ...
          question_analysis: [
            {
              analysis_type: 1,
              analysis_content:
                "从音频中可以听出红框中的旋律是渐强，所以选crescendo",
            },
          ],
          question_option: [
            {
